...
class Parser {
  ...
  std::vector<std::string> parse_enum_members(std::string stem,
                                              int indent_level);
  ...
  parse_name_type_pair(int member_indent);
...
public:
  ...
  Expression_ptr parse_ternary_condition(TokenType token_type,
